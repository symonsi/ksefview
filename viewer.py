...
def html_invoice(d):
    ...
    <table class="summary">
        <tr>
            ...
            <td class="value">{format_money(d["netto"])}</td>
        </tr>
        <tr>
            <td class="label">VAT:</td>
            <td class="value">{format_money(d["vat"])}</td>
        </tr>
        <tr>
            <td class="label"><b>Brutto:</b></td>
            <td class="value"><b>{format_money(d["brutto"])}</b></td>
        </tr>
    </table>
